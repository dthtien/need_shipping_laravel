    ...
    <div class="s5h-uformbox">
        <div class="s5h-uform">
            <form action="{!! route('postTaodonhang') !!}" method="post" name="formtaodonhang">
             <input type="hidden"  name="_token" value="{{ csrf_token() }}">
               @if (count($errors) > 0)
                ...
                <div class="form-group has-feedback">
                    ...
                    <input type="text" class="form-control" name="ShopAddress" id="add_autocomplete" autocomplete="off" value="" placeholder="Số nhà,Đường,Quận,TP(tỉnh)" required>
                </div>
                <div class="form-group has-feedback">
                ...
                <div>
                    ...
                    <input type="text" class="form-control" name="RecAddress" id="add_autocomplete" autocomplete="off" value="" placeholder="Số nhà,Đường,Quận,TP(tỉnh)" required>
                    <br>
                </div>
                <div class="form-group has-feedback">
             ...
             <div class="form-group has-feedback">
                 <input type="text" class="form-control" name="Note" id="add_autocomplete" autocomplete="off" value="" placeholder="Tên người nhận" required>
             </div>
             <div class="form-group has-feedback">
                 <h6 class="s5h-uform-title">Thông tin hàng hóa</h6>
                 <input type="text" class="form-control" name="NameGoods" id="add_autocomplete" autocomplete="off" value="" placeholder="Tên mặt hàng" required>
             </div>
             <div class="form-group has-feedback">
