             ...
             <input type="hidden"  name="_token" value="{{ csrf_token() }}">
               @if (count($errors) > 0)
                ...
                <div class="form-group has-feedback">
                    ...
                    <input type="text" class="form-control" name="ShopAddress" id="add_autocomplete" autocomplete="off" value="{{ Auth::user()->diachi }}" placeholder="Số nhà,Đường,Quận,TP(tỉnh)" required>
                </div>
                <div class="form-group has-feedback">
                    <input type="text" name="ShopPhone" id="Phone" class="form-control" placeholder="Số điện thoại" value="{{ Auth::user()->sdt }}" required>
                </div>
                <div>
