									...
									<td>
										...
										if(count($data2)>0)
										{
											foreach($data2 as $row1)
											{
												...
												?>
												<p style="cursor: pointer; text-decoration: none; color:#F24738; font-size: 18px;" class="" data-toggle="modal" data-target="#modal<?php echo e($ship[0]['id']); ?>"><?php echo e($ship[0]["name"]); ?>
												...
												<?php endif; ?>
												<!-- Modal -->
												<div id="modal<?php echo e($ship[0]['id']); ?>" class="modal fade" role="dialog">
													<div class="modal-dialog">
														<!-- Modal content-->
														<div class="modal-content">
															<div class="modal-header" style="background-color:#F24738; color: white;">
																<button type="button" class="close" data-dismiss="modal">&times;</button>
																<h4 style=" font-size: 20px;"><?php echo e($ship[0]["name"]); ?></h4>
															</div>
															<div class="modal-body" style="font-size: 18px; color: #4e4d55;text-align: left;">
																<table class="table table-condensed user-info">
																	<tbody>
																		<tr>
																			<th>Email: </th>
																			<td><?php echo e($ship[0]["email"]); ?></td>
																		</tr>
																		<tr>
																			<th> Số điện thoại </th>
																			<td> <?php echo e($ship[0]["sdt"]); ?></td>
																		</tr>
																		<tr>
																			<th>Địa chỉ:</th>
																			<td><?php echo e($ship[0]["diachi"]); ?></td>
																		</tr>
																		<tr>
																			<th>Nghề:</th>
																			<td><?php echo e($ship[0]["loai"]); ?></td>
																		</tr>
																	</tbody>
																</table>
															</div>
