...
<html lang="en">
    <head>
        ...
        <!-- Scripts -->
        <script>
            window.NeedShipper = <?php echo json_encode([
    ...
    <body>
        ...
        <div class="container">
            &copy; <?php echo e(date('Y')); ?>. Created by <a href="http://www.fb.com/dthtien" target="_blank">The Tiến</a>
            <br/>
        </div>
