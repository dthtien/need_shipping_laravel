              ...
              <div class="s5h-banner">
                  ...
                  <div class="row">
                    <div id="intro" class="col-sm-6 col-xs-12  col-sm-push-6">
                      ...
                      <ul class="s5h-bndown-ul">
                        <li class="s5h-bndown-ship"><a href="<?php echo e(url('dangnhap')); ?>" style=" color: #fff; font-size: 18px; " title="Đăng Nhập">
                          <i class="fa fa-sign-in w3-margin-right"></i>
                          ĐĂNG NHẬP
                        </a></li>
                        <li class="s5h-bndown-ship"><a href="<?php echo e(url('dangky')); ?>" style=" color: #fff; font-size: 18px; " title="Đăng ký nếu bạn chưa có tài khoản">
                   ...
                   <ul class="s5h-bndown-ul">
                    <li class="s5h-bndown-ship"><a href="<?php echo e(url('donhang')); ?>" title="Chuyển hàng ngay">
               ...
               <ul class="s5h-bndown-ul">
                 <li class="s5h-bndown-ship"><a href="<?php echo e(url('Taodonhang')); ?>" title="Tạo Đơn hàng">
             ...
             <div class="col-sm-6 col-xs-12 col-sm-pull-6">
              <div class="s5h-bnimg slideInUp wow" data-wow-duration="3s" data-wow-delay="1s" style="visibility: visible; animation-duration: 3s; animation-delay: 1s; animation-name: slideInUp;">
                ...
                <?php echo e(Html::image('ns/images/shipper1.png')); ?>;
              </div>
            </div>
          </div>
        </div>
